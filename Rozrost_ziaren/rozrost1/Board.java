                   ...
                   /* if(cellArray[column-radius][row-radius].getValue()==0){
                    ...
                    if(i!=1) {
                        for (int j = 0; j <= radius; ++j) {
                            ...
                            if (row - j >= 0 && cellArray[column][row - j].getValue() != 0) {
                                bigChecker = true;
                                break;
                            }
                        }
                    ...
                    if (i!=1 && bigChecker == false) {
                        ...
                        for (int j = 0; j <= radius; ++j) {
                            if (row + j < rows && cellArray[column][row + j].getValue() != 0) {
                                bigChecker = true;
                                break;
                            }
                        }
                    ...
                    if (i!=1 && bigChecker == false) {
                        for (int j = 0; j <= radius; ++j) {
                            ...
                            if (column - j >= 0 && cellArray[column - j][row].getValue() != 0) {
                                bigChecker = true;
                                break;
                            }
                        }
                    ...
                    if (i!=1 && bigChecker == false) {
                        for (int j = 0; j <= radius; ++j) {
                            ...
                            if (column + j < columns && cellArray[column + j][row].getValue() != 0) {
                                bigChecker = true;
                                break;
                            }
                        }
                    ...
                    if (i!=1 && bigChecker == false) {
                        for(int k=0;k<=radius; ++k) {
                            for (int j = 0; j <= radius; ++j) {
                                ...
                                if (column - j >= 0 && row - k >= 0 && cellArray[column - j][row - k].getValue() != 0) {
                                    bigChecker = true;
                                    break;
                                }
                            }
                    ...
                    if (i!=1 && bigChecker == false) {
                        for(int k=0;k<=radius; ++k) {
                            for (int j = 0; j <= radius; ++j) {
                                ...
                                if (column + j < columns && row - k >= 0 && cellArray[column + j][row - k].getValue() != 0) {
                                    bigChecker = true;
                                    break;
                                }
                            }
                    ...
                    if (i!=1 && bigChecker == false) {
                        for(int k=0;k<=radius; ++k) {
                            for (int j = 0; j <= radius; ++j) {
                                ...
                                if (column - j >= 0 && row + k < rows && cellArray[column - j][row + k].getValue() != 0) {
                                    bigChecker = true;
                                    break;
                                }
                            }
